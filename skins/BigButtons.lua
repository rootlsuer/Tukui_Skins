...
local StripedMelonSeedsButton = CreateBigButton("StripedMelonSeeds",89329,'item','Striped Melon Seeds',function() return GetSubZoneText() == "Sunsong Ranch" and GetItemCount(89239) > 0 end,"PLAYER_ENTERING_WORLD","ZONE_CHANGED","UNIT_INVENTORY_CHANGED")
