...
local function SkinShieldMonitor(self)
	...
	shieldmonitor_Frame:HookScript("OnShow", function(self)	U.SkinFrame(self, "Default", true) end)
	shieldmonitor_Frame:RegisterEvent("UNIT_AURA")
	shieldmonitor_Frame:HookScript("OnEvent", function(self) U.SkinFrame(self, "Default", true)	end)
	shieldmonitor_Frame:SetSize(209, 20)
	shieldmonitor_Bar:SetStatusBarTexture(U.NormTex)
	...
	shieldmonitor_BarText:SetFont(U.Font, 12, "OUTLINE")
	shieldmonitor_BarText:SetPoint("CENTER", shieldmonitor_Bar, "CENTER", 0, 0)
	shieldmonitor_FrameDuration:SetFont(U.Font, 12, "OUTLINE")
