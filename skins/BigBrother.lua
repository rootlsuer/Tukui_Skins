...
function AS:SkinBigBrother()
	...
	BigBrother_BuffWindow.LeftButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	BigBrother_BuffWindow.RightButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
