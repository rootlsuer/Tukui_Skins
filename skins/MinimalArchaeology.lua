...
local function SkinMinimalArchaeology(self)
	...
	MinArchMainButtonOpenArch.text:SetFont(U.Font, U.DataTextFontSize, "OUTLINE")
	...
	MinArchMainButtonOpenHist.text:SetFont(U.Font, U.DataTextFontSize, "OUTLINE")
	...
	MinArchMainButtonOpenADI.text:SetFont(U.Font, U.DataTextFontSize, "OUTLINE")
