...
local name = 'ATSWSkin'
function US:SkinATSW()
	US:SkinFrame(ATSWFrame)
	...
	US:SkinStatusBar(ATSWRankFrame)
	...
	US:SkinButton(ATSWQueueAllButton)
	US:SkinButton(ATSWCreateAllButton)
	US:SkinButton(ATSWCreateButton)
	US:SkinButton(ATSWQueueButton)
	US:SkinButton(ATSWQueueStartStopButton)
	US:SkinButton(ATSWQueueDeleteButton)
	US:SkinButton(ATSWReagentsButton)
	US:SkinButton(ATSWOptionsButton)
	US:SkinButton(ATSWCSButton)
	US:SkinButton(ATSWBuyReagentsButton)
	US:SkinButton(ATSWOptionsFrameOKButton)
	US:SkinButton(ATSWAddCategoryButton)
	US:SkinCloseButton(ATSWFrameCloseButton)
	US:SkinCloseButton(ATSWReagentFrameCloseButton)
	...
	US:SkinCheckBox(ATSWHeaderSortButton)
	US:SkinCheckBox(ATSWNameSortButton)
	US:SkinCheckBox(ATSWDifficultySortButton)
	US:SkinCheckBox(ATSWCustomSortButton)
	US:SkinCheckBox(ATSWOnlyCreatableButton)
	US:SkinCheckBox(ATSWOFUnifiedCounterButton)
	US:SkinCheckBox(ATSWOFSeparateCounterButton)
	US:SkinCheckBox(ATSWOFIncludeBankButton)
	US:SkinCheckBox(ATSWOFIncludeAltsButton)
	US:SkinCheckBox(ATSWOFIncludeMerchantsButton)
	US:SkinCheckBox(ATSWOFAutoBuyButton)
	US:SkinCheckBox(ATSWOFTooltipButton)
	US:SkinCheckBox(ATSWOFShoppingListButton)
	US:SkinCheckBox(ATSWOFReagentListButton)
	...
	US:SkinTooltip(ATSWTradeskillTooltip)
	US:SkinFrame(ATSWReagentFrame)
	US:SkinFrame(ATSWOptionsFrame)
	ATSWOptionsFrame:SetScale(c.general.uiscale)

	US:SkinFrame(ATSWCSFrame)
	...
	US:SkinScrollBar(ATSWCSUListScrollFrameScrollBar)
	US:SkinScrollBar(ATSWCSSListScrollFrameScrollBar)
	US:SkinCloseButton(ATSWCSFrameCloseButton)

	for i = 1, 4 do
		US:SkinButton(_G["ATSWQueueItem"..i.."DeleteButton"])
	end
	...
	US:SkinScrollBar(ATSWQueueScrollFrameScrollBar)
	US:SkinNextPrevButton(ATSWIncrementButton)
	US:SkinNextPrevButton(ATSWDecrementButton)
	US:SkinButton(ATSWAutoBuyButton)

	US:SkinFrame(ATSWShoppingListFrame)
	ATSWShoppingListFrame:SetScript("OnUpdate", function(self)
		self:Size(475,150)
		self:ClearAllPoints()
		self:Point("TOPRIGHT", AuctionFrame, "BOTTOMRIGHT", 0, -1)
	end)
	US:SkinButton(ATSWSLCloseButton, true)
	...
	US:SkinScrollBar(ATSWSLScrollFrameScrollBar)

	US:SkinButton(ATSWScanDelayFrameSkipButton)
	US:SkinButton(ATSWScanDelayFrameAbortButton)
	US:SkinFrame(ATSWScanDelayFrame)
	US:SkinStatusBar(ATSWScanDelayFrameBar, true)
	ATSWInputBox:SetJustifyH("CENTER")
end

US:RegisterSkin(name, US.SkinATSW)