...
function AS:SkinRecount()
	...
	Recount.MainWindow.RightButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	Recount.MainWindow.LeftButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	Recount.MainWindow.ResetButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	Recount.MainWindow.FileButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	Recount.MainWindow.ConfigButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	Recount.MainWindow.ReportButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	Recount.DetailWindow.ReportButton:FontString("text", AS.PixelFont, AS.DataTextFontSize, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	ResetFrame:Hide()
	ResetFrame:FontString("text", AS.PixelFont, 14, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	ResetAccept:FontString("text", AS.PixelFont, 14, "OUTLINE") --"MONOCHROMEOUTLINE"
	...
	ResetClose:FontString("text", AS.PixelFont, 14, "OUTLINE") --"MONOCHROMEOUTLINE"
