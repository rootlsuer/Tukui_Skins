...
function US:SkinRecount()
	local Recount = _G.Recount	
	local function SkinFrame(frame)
		frame.bgMain = CreateFrame("Frame", nil, frame)
		US:SkinFrame(frame.bgMain,"Default")
		...
		US:SkinFrame(frame.TitleBackground, "Default")
		...
		frame.CloseButton.t:SetFont(US.PixelFont, US.DataTextFontSize, "OUTLINE")
	...
	local function SkinMainFrame(frame)
		...
		frame.bgMain:SetPoint("TOP", frame, "TOP", 0, -7)
		frame.bgMain:SetFrameLevel(frame:GetFrameLevel())
		if not US:CheckOption("RecountBackdrop") then frame.bgMain:Hide() end
		frame.CloseButton:SetPoint("TOPRIGHT", frame, "TOPRIGHT", -1, -9)
		frame:SetBackdrop(nil)
	...
	Recount.UpdateBarTextures = function(self)
		for k, v in pairs(Recount.MainWindow.Rows) do
			v.StatusBar:SetStatusBarTexture(US.NormTex)
	...
	US:SkinScrollBar(Recount_MainWindow_ScrollBarScrollBar)
	...
	US:SkinFrame(Recount.MainWindow.CloseButton)

	US:SkinFrame(Recount.MainWindow.RightButton)
	...
	Recount.MainWindow.RightButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	US:SkinFrame(Recount.MainWindow.LeftButton)
	...
	Recount.MainWindow.LeftButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	US:SkinFrame(Recount.MainWindow.ResetButton)
	...
	Recount.MainWindow.ResetButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	US:SkinFrame(Recount.MainWindow.FileButton)
	...
	Recount.MainWindow.FileButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	US:SkinFrame(Recount.MainWindow.ConfigButton)
	...
	Recount.MainWindow.ConfigButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	US:SkinFrame(Recount.MainWindow.ReportButton)
	...
	Recount.MainWindow.ReportButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	US:SkinFrame(Recount.DetailWindow.ReportButton)
	...
	Recount.DetailWindow.ReportButton:FontString("text", US.PixelFont, US.DataTextFontSize, "MONOCHROMEOUTLINE")
...
US:RegisterSkin(name, US.SkinRecount)