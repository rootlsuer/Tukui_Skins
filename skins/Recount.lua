...
local function SkinRecount(self)
	...
	local function SkinFrame(frame)
		...
		U.SkinFrame(frame.bgMain,"Default")
		...
		U.SkinFrame(frame.TitleBackground, "Default")
		...
		frame.CloseButton.t:SetFont(U.PixelFont, U.DataTextFontSize, "OUTLINE")
	...
	Recount.UpdateBarTextures = function(self)
		for k, v in pairs(Recount.MainWindow.Rows) do
			v.StatusBar:SetStatusBarTexture(U.NormTex)
	...
	U.SkinFrame(Recount.MainWindow.CloseButton)

	U.SkinFrame(Recount.MainWindow.RightButton)
	...
	Recount.MainWindow.RightButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	U.SkinFrame(Recount.MainWindow.LeftButton)
	...
	Recount.MainWindow.LeftButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	U.SkinFrame(Recount.MainWindow.ResetButton)
	...
	Recount.MainWindow.ResetButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	U.SkinFrame(Recount.MainWindow.FileButton)
	...
	Recount.MainWindow.FileButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	U.SkinFrame(Recount.MainWindow.ConfigButton)
	...
	Recount.MainWindow.ConfigButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	U.SkinFrame(Recount.MainWindow.ReportButton)
	...
	Recount.MainWindow.ReportButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
	...
	U.SkinFrame(Recount.DetailWindow.ReportButton)
	...
	Recount.DetailWindow.ReportButton:FontString("text", U.PixelFont, U.DataTextFontSize, "MONOCHROMEOUTLINE")
