...
local function SkinPowerAuras(self)
	...
	U.SkinSlideBar(PowaBarAuraTextureSlider, 6)
	U.SkinSlideBar(PowaBarAuraAlphaSlider, 6)
	U.SkinSlideBar(PowaBarAuraSizeSlider, 6)
	U.SkinSlideBar(PowaBarAuraCoordXSlider, 6)
	U.SkinSlideBar(PowaBarAuraCoordSlider, 6)
	U.SkinSlideBar(PowaBarAuraSymSlider, 6)
	U.SkinSlideBar(PowaBarAuraDeformSlider, 6)
	U.SkinSlideBar(PowaBarAuraAnimSpeedSlider, 6)
	U.SkinSlideBar(PowaBarAuraDurationSlider, 6)
	U.SkinSlideBar(PowaTimerCoordXSlider, 6)
	U.SkinSlideBar(PowaTimerSizeSlider, 6)
	U.SkinSlideBar(PowaTimerCoordSlider, 6)
	U.SkinSlideBar(PowaTimerAlphaSlider, 6)
	U.SkinSlideBar(PowaTimerInvertAuraSlider, 6)
	U.SkinSlideBar(PowaStacksCoordXSlider, 6)
	U.SkinSlideBar(PowaStacksCoordSlider, 6)
	U.SkinSlideBar(PowaStacksSizeSlider, 6)
	U.SkinSlideBar(PowaStacksAlphaSlider, 6)
