...
local function LoadSkin()
	...
	local function FixSkin()
		...
		WorldMapFrameAreaLabel:SetFont(AS.Font, 50, "OUTLINE")
		WorldMapFrameAreaLabel:SetShadowOffset(2, -2)
		WorldMapFrameAreaLabel:SetTextColor(0.90, 0.8294, 0.6407)	
		
		WorldMapFrameAreaDescription:SetFont(AS.Font, 40, "OUTLINE")
		WorldMapFrameAreaDescription:SetShadowOffset(2, -2)	
		
		WorldMapZoneInfo:SetFont(AS.Font, 27, "OUTLINE")
	...
	WorldMapFrame:HookScript("OnEvent", function(self, event)
		...
		elseif event == "PLAYER_REGEN_DISABLED" then
			...
			if (quest) and (miniWorldMap or Taint) then
				...
				WorldMapQuestShowObjectives.Show = AS.Noop
				WorldMapTitleButton.Show = AS.Noop
				WorldMapBlobFrame.Show = AS.Noop
				WorldMapPOIFrame.Show = AS.Noop
	...
	coords:FontString("PlayerText", AS.Font, fontheight, "THINOUTLINE")
	coords:FontString("MouseText", AS.Font, fontheight, "THINOUTLINE")
	...
	WorldMapContinentDropDownButton:HookScript("OnClick", function() DropDownList1:SetScale(AS.UIScale) end)
	WorldMapZoneDropDownButton:HookScript("OnClick", function(self) 
		DropDownList1:SetScale(AS.UIScale)
