...
local function LoadSkin()
	...
	hooksecurefunc("PlayerTalentFrame_UpdateSpecFrame", function(self, spec)
		...
		for i = 1, GetNumSpecializations(nil, self.isPet) do
			...
			if bu.selected then
				...
				bu.backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
				bu.border.backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
			end
		end
	end)
	...
	for _, name in pairs(buttons) do
		for i = 1, 4 do
			...
			_G["PlayerTalentFrameSpecializationSpecButton"..i.."Glow"].Show = AS.Noop
		...
		for i = 1, MAX_NUM_TALENT_TIERS do
			for j = 1, NUM_TALENT_COLUMNS do
				...
				if bu.knownSelection:IsShown() then
					...
					bu.backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
					bu.bg.backdrop:SetBackdropColor(unpack(AS.BackdropColor))
					bu.bg.backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
				end
