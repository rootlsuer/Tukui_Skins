...
local function LoadSkin()
	...
	EncounterJournal.backdrop:Point("TOPLEFT", EncounterJournal, "TOPLEFT", -AS.Mult*3, AS.Mult*3)
	EncounterJournal.backdrop:Point("BOTTOMRIGHT", EncounterJournal, "BOTTOMRIGHT", AS.Mult*3, -AS.Mult*3)
	...
	EncounterJournal.backdrop2:SetTexture(unpack(AS.BorderColor))
	EncounterJournal.backdrop2:Point("TOPLEFT", EncounterJournal, "TOPLEFT", -AS.Mult*2, AS.Mult*2)
	EncounterJournal.backdrop2:Point("BOTTOMRIGHT", EncounterJournal, "BOTTOMRIGHT", AS.Mult*2, -AS.Mult*2)						
	...
	EncounterJournal.backdrop3:Point("TOPLEFT", EncounterJournal, "TOPLEFT", -AS.Mult, AS.Mult)
	EncounterJournal.backdrop3:Point("BOTTOMRIGHT", EncounterJournal, "BOTTOMRIGHT", AS.Mult, -AS.Mult)					
	...
	EncounterJournal.backdrop4:SetTexture(unpack(AS.BackdropColor))
	...
	EncounterJournal:HookScript("OnShow", function()
		...
		if not EncounterJournalEncounterFrameInfo.backdrop then						
			...
			EncounterJournalEncounterFrameInfo.backdrop:Point("TOPLEFT", EncounterJournalEncounterFrameInfoBG, "TOPLEFT", -AS.Mult*3, AS.Mult*3)
			EncounterJournalEncounterFrameInfo.backdrop:Point("BOTTOMRIGHT", EncounterJournalEncounterFrameInfoBG, "BOTTOMRIGHT", AS.Mult*3, -AS.Mult*3)
			...
			EncounterJournalEncounterFrameInfo.backdrop2:SetTexture(unpack(AS.BorderColor))
			EncounterJournalEncounterFrameInfo.backdrop2:Point("TOPLEFT", EncounterJournalEncounterFrameInfoBG, "TOPLEFT", -AS.Mult*2, AS.Mult*2)
			EncounterJournalEncounterFrameInfo.backdrop2:Point("BOTTOMRIGHT", EncounterJournalEncounterFrameInfoBG, "BOTTOMRIGHT", AS.Mult*2, -AS.Mult*2)						
			...
			EncounterJournalEncounterFrameInfo.backdrop3:Point("TOPLEFT", EncounterJournalEncounterFrameInfoBG, "TOPLEFT", -AS.Mult, AS.Mult)
			EncounterJournalEncounterFrameInfo.backdrop3:Point("BOTTOMRIGHT", EncounterJournalEncounterFrameInfoBG, "BOTTOMRIGHT", AS.Mult, -AS.Mult)								
		end
