...
local function LoadSkin()
	...
	local function UpdateFactionSkins()
		...
		for i=1, GetNumFactions() do
			...
			if statusbar then
				statusbar:SetStatusBarTexture(AS.NormTex)
	...
	--PetPaperDollFrameExpBar:SetStatusBarTexture(AS.NormTex)
	...
	local function ColorItemBorder()
		for _, slot in pairs(slots) do
			...
			if itemId then
				...
				target.backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
			end
		end
	end
