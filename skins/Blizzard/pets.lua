...
local function LoadSkin()
	...
	local function ColorSelectedMount()
		for i = 1, #MountJournal.ListScrollFrame.buttons do
			...
			if b.DragButton.ActiveTexture:IsShown() then
				...
				b.backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
			end
		end
	end
	...
	for i=1, 3 do
		...
		_G["PetJournalLoadoutPet"..i.."HealthFrame"].healthBar:SetStatusBarTexture(AS.NormTex)
		_G["PetJournalLoadoutPet"..i.."XPBar"]:StripTextures()
		_G["PetJournalLoadoutPet"..i.."XPBar"]:CreateBackdrop("Default")
		_G["PetJournalLoadoutPet"..i.."XPBar"]:SetStatusBarTexture(AS.NormTex)
	...
	PetJournalPetCardHealthFrame.healthBar:SetStatusBarTexture(AS.NormTex)
	PetJournalPetCardXPBar:StripTextures()
	PetJournalPetCardXPBar:CreateBackdrop("Default")
	PetJournalPetCardXPBar:SetStatusBarTexture(AS.NormTex)
