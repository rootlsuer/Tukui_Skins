...
local name = "Blizzard_AuctionUISkin"
function AS:SkinBlizzard_AuctionUI(event, addon)
	if event == "PLAYER_ENTERING_WORLD" or addon ~= "Blizzard_AuctionUI" then return end
	...
	AuctionProgressBar:SetStatusBarTexture(AS.NormTex)
	...
	for i = 1, NUM_AUCTIONS_TO_DISPLAY do
		...
		_G["AuctionsButton"..i.."ItemIconTexture"].SetTexCoord = AS.Noop
...
AS:RegisterSkin(name, AS.SkinBlizzard_AuctionUI, "ADDON_LOADED")