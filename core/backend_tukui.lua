...
local SkinOptions = CreateFrame("Frame", "SkinOptions", UIParent)
	...
	ApplySkinSettingsButton:SkinButton()
	...
	EmbedWindowSettingsButton:SkinButton()
	...
	SkinOptionsCloseButton:SkinButton()
